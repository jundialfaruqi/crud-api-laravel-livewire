<header class="navbar navbar-expand-md d-none d-lg-flex d-print-none sticky-top shadow-sm">
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            <div class="d-none d-md-flex">
                ...
                <div class="nav-item dropdown d-none d-md-flex me-3 btn-animate-icon btn-animate-icon-shake">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card rounded-4">
