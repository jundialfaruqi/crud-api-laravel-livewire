    ...
    <div class="col">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <p class="text-secondary mb-3 mb-md-0 small">Kelola data peran pengguna</p>
            </div>
        </div>
    </div>
        ...
        <div class="ms-auto d-flex flex-wrap btn-list">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-3 rounded-4" style="min-width: 280px;">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input rounded-circle" type="checkbox"
                            wire:model.live="showColumns.guard_name" id="col-guard">
                        <label class="form-check-label" for="col-guard">
                            Guard Name
                        </label>
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input rounded-circle" type="checkbox"
                            wire:model.live="showColumns.permissions" id="col-permissions">
                        <label class="form-check-label" for="col-permissions">
                            Permissions
                        </label>
                    </div>
                    <hr class="my-2">
