                ...
                <div class="d-flex align-items-center">
                    <div class="avatar bg-primary text-white rounded-circle me-2 mb-md-0 flex-shrink-0"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            stroke-linejoin="round" class="icon icon-tabler-key-plus">
                            <path d="M16 10h2a2 2 0 0 1 2 2v1" />
                            <path d="M12 21h-7a2 2 0 0 1 -2 -2v-7a2 2 0 0 1 2 -2h7l3 -3a2 2 0 0 1 3 0l2 2a2 2 0 0 1 0 3l-3 3" />
                            <path d="M16 19h6" />
                            <path d="M19 16v6" />
                        </svg>
                    </div>
                    <div>
                        <h3 class="card-title">{{ $editMode ? 'Edit Permission' : 'Tambah Permission Baru' }}</h3>
                        <p class="text-muted mb-0 small">
                            {{ $editMode ? 'Perbarui informasi permission di bawah ini' : 'Lengkapi form di bawah untuk menambahkan permission baru' }}
                        </p>
                    </div>
                </div>
                    ...
                    <div class="space-y">
                        <div class="row row-cols-1 row-cols-md-2 g-4">
                            <div>
                                ...
                                <input type="text" wire:model="name" placeholder="Masukkan nama permission"
